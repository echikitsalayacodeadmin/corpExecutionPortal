...
const OrgAnalysisAuthLayout = ({ children }) => {
  const [corpName, setCorpName] = useState(
    localStorage.getItem("CORP_NAME_ORG_ANALYSIS")
  );
  const [corpId, setCorpId] = useState(
    localStorage.getItem("CORP_ID_ORG_ANALYSIS")
  );
...
export default OrgAnalysisAuthLayout;
