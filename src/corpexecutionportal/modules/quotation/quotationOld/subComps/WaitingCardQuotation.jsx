...
import userProfileCircleIcon from "../../../../assets/images/userProfileCircleIcon.png";
import { useNavigate } from "react-router-dom";

const WaitingCardQuotation = ({ data }) => {
    ...
    <Fragment>
      ...
      >
        <Grid item xs={6} lg={6} sx={{ display: "flex" }}>
          <img src={userProfileCircleIcon} width={30} height={30} alt="Icon" />
        ...
        <Grid item xs={1} lg={1} textAlign="right">
          <IconButton
            onClick={() => {
              navigate(`/corp/quotation/quotationdetails/${data?.corpSalesId}`);
            }}
...
export default WaitingCardQuotation;
