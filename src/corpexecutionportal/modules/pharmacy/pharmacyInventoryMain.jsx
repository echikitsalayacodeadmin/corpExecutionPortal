    ...
    if (medicineList) {
      setMedicineListUpdated(
        medicineList.map((item, index) => ({
          ...
          secondaryPackingUnitName: item["secondarypackageunitname"],
          primaryPackingUnitName: item["primarypackageunitname"],
          baseUnit: item["baseunit"],
          secondaryConversionUnit: item["secondaryconversionunit"],
          primaryConversionUnit: item["primaryconversionunit"],
          nearExpiryDuration: item["nearexpiryduration"],
